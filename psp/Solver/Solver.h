...
public:
    /**
     ...
     @para filter Only problems which will be filtered (problems on which filter returns true) will be considered. This function with two parameters: 1 - number of problem in problems list, 2 - name of problem
     */
